...
import com.deep.request.CreateChatRequest;
import com.deep.services.ChatService;
...
public class ChatController {
	...
	public  Chat findChatByChatId(@PathVariable("chatId") Integer chatId) throws ChatException{
